    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.CharField(max_length=255, null=True)),
                ('product_images1', models.ImageField(null=True, upload_to='sample/')),
                ('product_images2', models.ImageField(null=True, upload_to='sample/')),
                ('product_images3', models.ImageField(null=True, upload_to='sample/')),
                ('product_images4', models.ImageField(null=True, upload_to='sample/')),
