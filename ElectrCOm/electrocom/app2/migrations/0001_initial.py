    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_images1', models.ImageField(blank=True, null=True, upload_to='sample/')),
                ('product_images2', models.ImageField(blank=True, max_length=255, null=True, upload_to='sample/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.CharField(max_length=255, null=True)),
                ('product_images1', models.ImageField(blank=True, max_length=255, null=True, upload_to='sample/')),
                ('product_images2', models.ImageField(blank=True, max_length=255, null=True, upload_to='sample/')),
                ('product_images3', models.ImageField(blank=True, max_length=255, null=True, upload_to='sample/')),
                ('product_images4', models.ImageField(blank=True, max_length=255, null=True, upload_to='sample/')),
